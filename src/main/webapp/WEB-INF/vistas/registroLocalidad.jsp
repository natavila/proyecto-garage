...
<head>
	...
	<body>
		<main class="container"> <!-- Clase de Bootstrap. Hace que los elementos no lleguen hasta el borde -->
			<form:form  action="procesarRegistroLocalidad" method="POST" modelAttribute="localidad" class="row g-3">
			<h1 class="mt-3">Registar Localidad</h1>

				<div class="col-md-6">			
		    <label for="localidad" class="form-label control-label" required>Nombre</label>
